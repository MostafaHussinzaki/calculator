...
const changeTheme = function(themeNom1 = 1, prevTheme1) {
    document.body.classList.remove(`theme${prevTheme1}-bg-main`);
    document.body.classList.add(`theme${themeNom1}-bg-main`);
    bgToggle.classList.remove(`bg-${prevTheme1}`);
    bgToggle.classList.add(`bg-${themeNom1}`);
    fontColor.forEach((el1)=>{
        el1.classList.remove(`fc-theme${prevTheme1}`);
        el1.classList.add(`fc-theme${themeNom1}`);
    });
    bgSecondry1.forEach((el1)=>{
        el1.classList.remove(`theme${prevTheme1}-bg-secondry-1`);
        el1.classList.add(`theme${themeNom1}-bg-secondry-1`);
    });
    bgSecondry2.forEach((el1)=>{
        el1.classList.remove(`theme${prevTheme1}-bg-secondry-2`);
        el1.classList.add(`theme${themeNom1}-bg-secondry-2`);
    });
    mainKey.forEach((el1)=>{
        el1.classList.remove(`theme${prevTheme1}-main-key`);
        el1.classList.add(`theme${themeNom1}-main-key`);
    });
    secondryKey.forEach((el1)=>{
        el1.classList.remove(`theme${prevTheme1}-secondry-key`);
        el1.classList.add(`theme${themeNom1}-secondry-key`);
    });
    thirdKey.forEach((el1)=>{
        el1.classList.remove(`theme${prevTheme1}-third-key`);
...
toggle.addEventListener("click", function() {
    ...
    let currtheme1 = this.dataset.theme;
    // declare previous theme
    let prevTheme1 = currtheme1 == 1 ? 3 : currtheme1 - 1;
    // change Theme
    changeTheme(currtheme1, prevTheme1);
});
